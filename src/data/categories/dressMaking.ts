...
export const dressMakingProjects: Project[] = [
  ...
  // Previous Pattern and Draping Work
  {
    id: 124,
  ...
  {
    id: 134,
    title: "Korean Look Pattern Technical Draft",
    category: "Dress making ( pattern+ draping)",
    description: "Technical pattern draft for Korean look garment featuring detailed measurements and construction lines. Shows professional pattern making with collar, sleeve and back panel specifications for size 42.",
    image: "/lovable-uploads/17550805-80b5-4cab-a059-df2ffb67f5c0.png",
    tools: ["Korean Fashion Pattern", "Technical Drafting", "Size Grading"],
    year: "2024"
  },
  {
    id: 135,
    title: "Mutton Sleeve Pattern Design",
    category: "Dress making ( pattern+ draping)",
    description: "Comprehensive pattern layout for garment with mutton sleeves showing front and back panels with detailed measurements. Features professional pattern making techniques with size grading specifications.",
    image: "/lovable-uploads/36d7b5a2-0d8f-43ba-a9b5-5077867362de.png",
    tools: ["Mutton Sleeve", "Pattern Layout", "Size Grading"],
    year: "2024"
  },
  {
    id: 136,
    title: "Fabric Construction Pattern Guide",
    category: "Dress making ( pattern+ draping)",
    description: "Advanced fabric construction pattern showing bias cut techniques and diagonal pattern placement. Features detailed measurements and professional pattern making for fabric optimization.",
    image: "/lovable-uploads/8cc3f546-57ab-426c-a4d4-b3c557d15c0c.png",
    tools: ["Bias Cut", "Fabric Construction", "Pattern Optimization"],
    year: "2024"
  },
  {
    id: 137,
    title: "Sleeve Cap Pattern Construction",
    category: "Dress making ( pattern+ draping)",
    description: "Technical pattern for sleeve cap construction showing bicep level measurements and professional pattern making. Features detailed front and back panels with Spring-23 assignment specifications.",
    image: "/lovable-uploads/2006b58e-bd91-4ed9-9660-320a04d95883.png",
    tools: ["Sleeve Cap", "Bicep Construction", "Pattern Making"],
    year: "2024"
  },
  {
    id: 138,
    title: "Advanced Pocket Pattern Layout",
    category: "Dress making ( pattern+ draping)",
    description: "Detailed pocket pattern construction showing front and back panels with precise measurements. Features professional pattern making techniques with size grading and technical specifications.",
    image: "/lovable-uploads/cbb2545b-6547-43ed-b3b6-773cd3339a74.png",
    tools: ["Pocket Construction", "Front Panel", "Back Panel"],
    year: "2024"
  },
  {
    id: 139,
    title: "Jumpsuit Pattern Back Construction",
    category: "Dress making ( pattern+ draping)",
    description: "Technical back panel pattern for jumpsuit construction featuring detailed measurements and bust level specifications. Shows professional pattern making for Tunics style garment in size 42.",
    image: "/lovable-uploads/17627e89-4a18-4a23-ae80-2344e8d1b275.png",
    tools: ["Jumpsuit Pattern", "Back Construction", "Bust Level"],
    year: "2024"
  },
  {
    id: 140,
    title: "Circular Skirt Pattern Design",
    category: "Dress making ( pattern+ draping)",
    description: "Advanced circular skirt pattern showing radius calculations and curved construction lines. Features professional pattern making with detailed measurements and geometric pattern construction.",
    image: "/lovable-uploads/e61f4b40-8aab-4e2f-9f38-dce29ef8ae4e.png",
    tools: ["Circular Skirt", "Radius Calculation", "Geometric Pattern"],
    year: "2024"
  },
  {
    id: 141,
    title: "Princess Style Camisole Pattern",
    category: "Dress making ( pattern+ draping)",
    description: "Princess style camisole top pattern for jumpsuit construction featuring detailed measurements and professional pattern making. Shows under arm level, bust level, and waist level specifications for size 42.",
    image: "/lovable-uploads/8e9bd5f8-d18c-4423-a89b-86b9421f21da.png",
    tools: ["Princess Style", "Camisole Pattern", "Jumpsuit Construction"],
    year: "2024"
  }
];
